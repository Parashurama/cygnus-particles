...
if __name__ == '__main__':
    ...
    window = PygletWindow(1440,800, caption='TestParticles0 MovingColors', vsync=False)   
    cygnus.Init()
    
    CAMERA_0 = CameraObject(translation = (0.0, 0.0, -1216.0),
                            rotation= (-210.0, -36.0, -20.0))
    ...
    trail = PerParticleEmitter( name='Trail0',
                                ...
                                renderer = PointRenderer( point_size=6.0, feather = 3.0,
